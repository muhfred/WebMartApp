...
angular.module('webmart.services', ['ngResource']);
...
angular.module('webmart.services').factory('Shop', function($resource){
...
angular.module('webmart.services').factory('Purchase', function($resource){
  return $resource('http://localhost\::port/webmart/rest/purchase/', 
            {port:8080}, {});
});

// shopping cart service:
angular.module('webmart.services').factory('Cart', function(){
