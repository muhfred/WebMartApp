...
angular.module('wemartApp.services', ['ngResource']);
...
angular.module('wemartApp.services').factory('Shop', function($resource){
  return $resource('http://localhost\::port/webmart/rest/department/:departmentId', 
            {departmentId:'@departmentId', port:8080}, {});
});

// make purchase service:
angular.module('wemartApp.services').factory('Purchase', function($resource){
  return $resource('http://localhost\::port/webmart/rest/purchase/', 
            {port:8080}, {});
});

// shopping cart service:
angular.module('wemartApp.services').factory('Cart', function(){
