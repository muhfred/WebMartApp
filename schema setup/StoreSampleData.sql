...
--
INSERT INTO `category` (name) VALUES ('computers and electronics'),('clothes'),('groceries'),('home appliances');


--
-- Sample data for table `product`
--
INSERT INTO `product` (`name`, price, description, category_id) VALUES ('milk', 1.70, 'semi skimmed (1L)', 3);
INSERT INTO `product` (`name`, price, description, category_id) VALUES ('cheese', 2.39, 'mild cheddar (330g)', 3);
INSERT INTO `product` (`name`, price, description, category_id) VALUES ('butter', 1.09, 'unsalted (250g)', 3);
INSERT INTO `product` (`name`, price, description, category_id) VALUES ('free range eggs', 1.76, 'medium-sized (6 eggs)', 3);

INSERT INTO `product` (`name`, price, description, category_id) VALUES ('organic meat patties', 2.29, 'rolled in fresh herbs<br>2 patties (250g)', 3);
INSERT INTO `product` (`name`, price, description, category_id) VALUES ('parma ham', 3.49, 'matured, organic (70g)', 3);
INSERT INTO `product` (`name`, price, description, category_id) VALUES ('chicken leg', 2.59, 'free range (250g)', 3);
INSERT INTO `product` (`name`, price, description, category_id) VALUES ('sausages', 3.55, 'reduced fat, pork<br>3 sausages (350g)', 3);
...
INSERT INTO `product` (`name`, price, description, category_id) VALUES ('corn on the cob', 1.59, '2 pieces', 3);
INSERT INTO `product` (`name`, price, description, category_id) VALUES ('red currants', 2.49, '150g', 3);
INSERT INTO `product` (`name`, price, description, category_id) VALUES ('broccoli', 1.29, '500g', 3);
INSERT INTO `product` (`name`, price, description, category_id) VALUES ('seedless watermelon', 1.49, '250g', 3);


INSERT INTO `product` (`name`, price, category_id) VALUES ('milk', 1.70, 3);
INSERT INTO `product` (`name`, price, category_id) VALUES ('cheese', 2.39, 3);
INSERT INTO `product` (`name`, price, category_id) VALUES ('butter', 1.09, 3);
INSERT INTO `product` (`name`, price, category_id) VALUES ('free range eggs', 1.76, 3);

INSERT INTO `product` (`name`, price, category_id) VALUES ('organic meat patties', 2.29, 3);
INSERT INTO `product` (`name`, price, category_id) VALUES ('parma ham', 3.49, 3);
INSERT INTO `product` (`name`, price, category_id) VALUES ('chicken leg', 2.59, 3);
INSERT INTO `product` (`name`, price, category_id) VALUES ('sausages', 3.55, 3);
...
INSERT INTO `product` (`name`, price, category_id) VALUES ('corn on the cob', 1.59, 3);
INSERT INTO `product` (`name`, price, category_id) VALUES ('red currants', 2.49, 3);
INSERT INTO `product` (`name`, price, category_id) VALUES ('broccoli', 1.29, 3);
INSERT INTO `product` (`name`, price, category_id) VALUES ('seedless watermelon', 1.49, 3);
